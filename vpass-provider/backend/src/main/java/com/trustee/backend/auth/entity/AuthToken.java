...
public class AuthToken {
    ...
    private String clientData; // Encrypted Phone
    private String name;       // Encrypted Name
    private String ci;         // [New] Connecting Information
    private String carrier;
    private String otp;

    // [New] Stores the UUID (auth_request_id) provided by Entruster
    ...
    public void setAuthRequestId(UUID authRequestId) {
